...
public class TestAdapter {
	...
	public int updateRequst(HandShakingQueryable object)
	{
		open();
		int temp=object.updateRequest(mDb);
		close();
		return temp;
	}
	
	public int updateAcknowledge(HandShakingQueryable object)
	{
		open();
		int temp=object.updateAcknowledge(mDb);
		close();
		return temp;
	}
